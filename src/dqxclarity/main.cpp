...
int main(int argc, char* argv[]) {
    ...
    // Find DQXGame.exe
    if (opt_verbose) std::cout << "[1/3] Looking for DQXGame.exe...\n";
    ...
    if (opt_verbose) std::cout << "  Found PID: " << pids[0] << "\n\n";

    // Create memory interface
    if (opt_verbose) std::cout << "[2/3] Attaching to process...\n";
    ...
    if (opt_verbose) std::cout << "  Attached successfully\n\n";

    // Create and install dialog hook
    if (opt_verbose) std::cout << "[3/3] Installing dialog hook...\n";
    ...
    if (opt_verbose) std::cout << "  Hook installed successfully\n\n";
