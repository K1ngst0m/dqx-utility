...
using PackageDownloadCallback =
    std::function<void(bool success, const std::string& filePath, const std::string& error)>;
...
public:
    ...
    void downloadAsync(const std::string& url, const std::string& destPath, PackageProgressCallback progressCallback,
