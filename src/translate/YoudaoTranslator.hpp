...
private:
    ...
    enum class Mode { Text, LargeModel };

    void workerLoop();
    bool doTextRequest(const std::string& text, const std::string& src_lang, const std::string& dst_lang, std::string& out_text);
    bool doLargeModelRequest(const std::string& text, const std::string& src_lang, const std::string& dst_lang, std::string& out_text);
    ...
    static std::string buildSignature(const std::string& app_key, const std::string& app_secret, const std::string& input, const std::string& salt, const std::string& curtime);
...
public:
    ...
    static std::string debugBuildSignature(const std::string& app_key,
    ...
    static std::string debugTruncateInput(const std::string& text)
    {
        return truncateInput(text);
    }
#endif
