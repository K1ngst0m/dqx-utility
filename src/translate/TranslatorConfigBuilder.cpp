...
namespace translate {
 ...
 static std::string safe_str(const std::array<char, ::TranslationConfig::URLSize>& a) {
     return a.data();
 }
 static std::string safe_model(const std::array<char, ::TranslationConfig::ModelSize>& a) {
     return a.data();
 }
 static std::string safe_key(const std::array<char, ::TranslationConfig::ApiKeySize>& a) {
     return a.data();
 }
 ...
 BackendConfig BackendConfig::from(const ::TranslationConfig& cfg_ui) {
     ...
     switch (cfg_ui.translation_backend) {
         ...
         case ::TranslationConfig::TranslationBackend::ZhipuGLM: {
             ...
             if (out.model.empty()) out.model = "glm-4-flash";
         ...
         case ::TranslationConfig::TranslationBackend::QwenMT: {
             ...
             if (out.model.empty()) out.model = "qwen-mt-turbo";
