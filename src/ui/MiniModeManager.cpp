...
ImGuiID MiniModeManager::SetupDockspace()
{
    ...
    ImGuiWindowFlags container_flags = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse |
    ...
    if (ImGui::Begin("MiniContainer###MiniContainer", nullptr, container_flags))
    {
        ImGuiDockNodeFlags dock_flags =
            ImGuiDockNodeFlags_NoSplit | ImGuiDockNodeFlags_NoResize | ImGuiDockNodeFlags_NoUndocking;
