...
struct MonsterStateManager;

class MonsterSettingsView
{
public:
    MonsterSettingsView(MonsterStateManager& state, FontManager& font_manager, TranslateSession& session, ConfigManager& config, GlobalStateManager& global_state);
